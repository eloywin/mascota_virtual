...
while mascota_en_caja == 0:
    ...
    if unboxing_mascota.lower() == "si":
        ...
        mascota_en_caja = 1
        break
    elif unboxing_mascota.lower() == "no":
        with alive_bar(150, bar="bubbles", spinner="arrows") as bar:
            for i in range(150):
                time.sleep(0.01)
                bar()
...
while usuario_salir == False:
    ...
    if seleccion_menu == 1:
        ...
        try:
            ...
            time.sleep(1.5)
            if text.lower() == "mascota siéntate":
                mascota.Parado = False
                with alive_bar(150, bar="bubbles", spinner="arrows") as bar:
                    for i in range(150):
                        time.sleep(0.01)
                        bar()
                print("[+]Tu mascota ahora esta sentada!")
                time.sleep(1.5)
            elif text.lower() == "mascota de pie":
                mascota.Parado = True
                with alive_bar(150, bar="bubbles", spinner="arrows") as bar:
                    for i in range(150):
                        time.sleep(0.01)
                        bar()
                print("[+]Tu mascota ahora esta de pie!")
                time.sleep(1.5)
            elif text.lower() == "los voy a matar":
                mascota.Parado = True
                with alive_bar(150, bar="bubbles", spinner="arrows") as bar:
                    for i in range(150):
                        time.sleep(0.01)
